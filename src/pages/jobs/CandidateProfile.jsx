    ...
    <div className="min-h-screen bg-slate-950 p-6 text-slate-100 dir-rtl" dir="rtl">
      <div className="mx-auto max-w-3xl">
        <div className="mb-6 flex items-center justify-between">
          <Link
            to="/my-applications"
            className="flex items-center gap-2 rounded-xl border border-slate-800 bg-slate-900 px-4 py-2 text-xs font-bold text-slate-300 hover:bg-slate-800"
          >
          ...
          <div className="flex flex-col items-center text-center sm:flex-row sm:text-right gap-6 border-b border-slate-800/80 pb-6">
            ...
            <div>
              ...
              <p className="text-xs font-semibold text-slate-400 mt-1">
                المرشح لوظيفة: <span className="text-indigo-300">{application.jobRole}</span>
              </p>
